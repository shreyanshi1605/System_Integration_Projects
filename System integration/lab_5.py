...
search = driver.find_element("xpath","/html/body/div[1]/header/div/div[1]/div[4]/button")
search.send_keys("    Shape of you")
search.send_keys(Keys.RETURN)
time.sleep(3)

song = driver.find_element("xpath","/html/body/div[1]/header/div/div[1]/div[4]/section/div[2]/div/div/section[1]/div[2]/ul/li[1]/div/a")
song.click()
time.sleep(3)

play = driver.find_element("xpath","/html/body/div[1]/main/div[2]/div/section[1]/div[3]/div[5]/button[1]")
play.click()
time.sleep(10)
...
#laptop_link = driver.find_element("xpath","/html/body/div[1]/div[1]/div[1]/div[1]/div/span[1]/div[1]/div[5]/div/div/div/div/div/div/div[2]/div[1]/h2/a/span")
...
#no_thanks_button= driver.find_element("xpath","/html/body/div[9]/div[3]/div[1]/div/div/div[2]/div[2]/div/div/div[3]/div/span[2]")
